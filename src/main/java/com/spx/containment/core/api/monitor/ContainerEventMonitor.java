...
@Slf4j
@ServerEndpoint(value = "/ws/container/events", configurator = WebSocketSpringConfigurator.class, encoders = {EventEncoder.class, MessageEncoderDecoder.class}, decoders = {
...
public class ContainerEventMonitor {
    ...
    @Autowired
    public ContainerEventMonitor(ClientSessionHandler sessionHandler, ContainerEventSubscription containerEventSubscription, ContainerServices containerServices) {
    ...
    @OnMessage
    public void onMessage(ContainerMonitorMessage message, Session session) throws IOException, EncodeException {

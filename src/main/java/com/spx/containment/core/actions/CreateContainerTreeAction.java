...
public class CreateContainerTreeAction implements Callable<Void> {
    ...
    CreateContainerTreeAction(ModelToViewAdaptor modelToViewMapper, ContainerServices containerServices, ContainerView[] containerViews, Set<ContainerEventListener> containerEventListeners) {
